...
| [`004-ios-client.md`](004-ios-client.md) | iOS client: `FindlyKit` SPM package, auth provider, design-swappable UX layer, screens |
...
Future specs claim the next number (e.g. `009-web-viz.md`, `0xx-subscriptions.md`).
